...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleUsernameNotFoundException(BadCredentialsException ex){
        Map<String,String> errs = new HashMap<>();
    ...
    public ResponseEntity<ApiResponse<Map<String,String>>> handleRuntimeException(CustomException ex){
        Map<String,String> errs = new HashMap<>();
        errs.put("errs", ex.getMessage());
        return ApiResponse.error(HttpStatus.BAD_REQUEST, errs.toString());
    }

        ...
        if (!(imagePath == null || imagePath.isEmpty())) {
            ...
            var userMessage = UserMessage.builder()
                        .text("Please analyze the image and extract a list of ingredients present in the image."+
                                "The answer only provide the ingredients in plain text format, separated by commas.") // content
                        .media(new Media(MimeTypeUtils.IMAGE_PNG, new FileSystemResource(imagePath))) // media
                        .build();
